...
func HandleApplicationDataInfluenceDataSubsToNotifySubscriptionIdDelete(
	...
	ApplicationDataInfluenceDataSubsToNotifySubscriptionIdDeleteProcedure(subscriptionId)

	return httpwrapper.NewResponse(http.StatusNoContent, nil, nil)
}

func ApplicationDataInfluenceDataSubsToNotifySubscriptionIdDeleteProcedure(subscriptionId string) {
...
func HandleApplicationDataInfluenceDataSubsToNotifySubscriptionIdGet(
	...
	pd, rspData := ApplicationDataInfluenceDataSubsToNotifySubscriptionIdGetProcedure(subscriptionId)
	if pd != nil {
		return httpwrapper.NewResponse(int(pd.Status), nil, pd)
	}
	return httpwrapper.NewResponse(http.StatusOK, nil, rspData)
...
func ApplicationDataInfluenceDataSubsToNotifySubscriptionIdGetProcedure(subscriptionID string) (*models.ProblemDetails, any) {
	...
	if subscription, ok := udrSelf.InfluenceDataSubscriptions.Load(subscriptionID); ok {
		...
		problemDetails := util.ProblemDetailsNotFound("USER_NOT_FOUND")
