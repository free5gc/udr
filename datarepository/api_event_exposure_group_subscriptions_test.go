...
func TestCreateQueryUpdateRemoveEeGroupSubscriptions(t *testing.T) {
	runTestServer(t)
	...
	{
		_, res, err := client.EventExposureGroupSubscriptionsCollectionApi.CreateEeGroupSubscriptions(context.TODO(), ueId, eeSubscription)
		if err != nil {
			t.Fatalf(err.Error())
		}
		...
		groupId = subsUri[strings.LastIndex(subsUri, "/")+1:]
		spew.Printf("[groupId] %s\n", groupId)
	}
	...
	{
		eeSubscriptionArray, res, err := client.EventExposureGroupSubscriptionsCollectionApi.QueryEeGroupSubscriptions(context.TODO(), ueId, &Nudr_DataRepository.QueryEeGroupSubscriptionsParamOpts{})
		if err != nil {
			t.Fatalf(err.Error())
		}
	...
	{
		res, err := client.EventExposureSubscriptionDocumentApi.UpdateEeGroupSubscriptions(context.TODO(), ueId, groupId, &Nudr_DataRepository.UpdateEeGroupSubscriptionsParamOpts{
	...
	{
		res, err := client.EventExposureSubscriptionDocumentApi.RemoveEeGroupSubscriptions(context.TODO(), ueId, groupId)
		if err != nil {
			t.Fatalf(err.Error())
		}
